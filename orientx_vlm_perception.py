...
class SimpleMoveit():
    ...
    def go_to_position(self, x_pos, y_pos, z_pos, orient_x):
        ...
        increment_roll = roll - change
        decrement_roll = roll + change

        
        if orient_x == 1:
            quaternion = tf.transformations.quaternion_from_euler(increment_roll, pitch, yaw)
        elif orient_x == 2:
            quaternion = tf.transformations.quaternion_from_euler(decrement_roll, pitch, yaw)
        elif orient_x == 0:
            return
...
if __name__ == "__main__":
    ...
    scene = 2
    trial = 10
    scene_name = "three_layer_gird_with_annotation_continuous_orientx_one_img_context"
    
    image_save_path = "/home/ur_5/Documents/gpt_tests/Data_paper/{}/scene_{}".format(scene_name, scene)
    result_path = "/home/ur_5/Documents/gpt_tests/Data_paper/{}/scene_{}/trial_{}/gpt_result_{}.txt".format(scene_name, scene,  trial, trial)
    
    current_position_path = "/home/ur_5/Documents/gpt_tests/Data_paper/{}/scene_{}/trial_{}/current_position_{}.txt".format(scene_name, scene, trial, trial)
    target_state_path = "/home/ur_5/Documents/gpt_tests/Data_paper/{}/scene_{}/trial_{}/target_position_{}.txt".format(scene_name, scene, trial, trial)
